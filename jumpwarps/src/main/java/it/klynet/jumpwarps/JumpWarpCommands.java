...
public class JumpWarpCommands extends BaseCommand {
    ...
    @SubCommand("help")
    @Permission("klynet.jumpwarps.help")
    ...
    @SubCommand("create")
    @Permission("klynet.jumpwarps.create")
    ...
    @SubCommand("delete")
    @Permission("klynet.jumpwarps.delete")
    ...
    @SubCommand("list")
    @Permission("klynet.jumpwarps.list")
