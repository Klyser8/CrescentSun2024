...
public class DatabaseManager {
    ...
    public DatabaseManager(KlyNetCore klyNetCore, String host, int port, String database, String username, String password, int maxPoolSize) {
    ...
    private String populateCreateTableQuery(String tableName) {
        ...
        // Primary key should be id found in KlyNetCore table
        columns.append(KlyNetNamespaceKeys.PLAYER_UUID.getKey()).append(" VARCHAR(36) NOT NULL PRIMARY KEY, ");
        // username column
...
//        klyNetCore.getLogger().info("Created query: " + query);
        return query;
    }
...
/*    private static String getColumnType(Object value) {
    ...
    public void initPlayerDataManager() {
        if (playerDataManager == null) {
            playerDataManager = new PlayerDataManager(klyNetCore, this);
        }
    }

    public void initServerDataManager() {
        if (serverDataManager == null) {
            serverDataManager = new ServerDataManager(klyNetCore, this);
        }
    }
