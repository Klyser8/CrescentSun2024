...
import it.klynet.klynetcore.api.event.player.PlayerDataFetchEvent;
import it.klynet.klynetcore.api.event.player.PlayerDataUpdateEvent;
...
public class PlayerData {
    ...
    public UUID getUniqueId() {
        return UUID.fromString(getData(KlyNetNamespaceKeys.PLAYER_UUID));
    }
    ...
    public <V> V getData(NamespacedKey namespacedKey) {
        ...
        if (data == null) {
            KlyNetCore.getInstance().getLogger().warning(
