...
public class JumpWarpManager extends AbstractPluginDataManager<JumpWarps, JumpWarpData> {
    ...
    public JumpWarpManager(JumpWarps plugin, PluginDataService pluginDataService) {
        super(plugin, JumpWarpData.class, pluginDataService);
    }
    ...
    public boolean doesServerDestinationExist(String serverDestination) {
        return plugin.getCrescentCoreAPI().getServerList().contains(serverDestination);
    }
